    ...
    def fair_cal(self):
        ...
        for user_wait_ratio in range(l):
            if self.user_waittime_ratio[user_wait_ratio] == [0, 0]:
                ...
                r1 = self.user_waittime_ratio[user_wait_ratio][0] / (self.user_waittime_ratio[user_wait_ratio][1] + self.user_waittime_ratio[user_wait_ratio][0] + 1e+5)
                wp.append(r1)
